...
function QuestionCard({ questionData, data, currentPage }) {
    ...
    const handleDelete = () => {
        router.delete(`/opcrquestion/${data.id}`);
    };

    const handleArchive = (id) => {
        router.put(`/opcrquestion/${id}/unarchive`, data, {
            preserveScroll: true,
        });
    };
        ...
        <Card className="m-3 mt-5 flex flex-col max-w-md w-[100%]">
            ...
            <div className="flex flex-col justify-end">
                <Button className="bg-orange-600 my-2 h-[3rem] w-[100%]">
                    <a
                        href={`/opcrquestion/${data.id}/edit?page=${currentPage}`}
                    >
                        Edit
                    </a>
                </Button>
                ...
                {/* delete */}
                <Button className="bg-red-600 my-2 h-[3rem] w-[100%]">
...
function OPCRArchive({ auth, opcrs }) {
    // flash usePage().props
                        ...
                        <Card>
                            <div className="flex justify-start  items-center">
                                <h2
                                    ...
                                    className="font-bold  mx-2 text-xl"
                                >
                                    Opcr Questions
                                </h2>
                                <h2 className="mx-2 text-orange-500 underline underline-offset-[1rem] font-bold text-xl">
                                    Archives
                                </h2>
                            </div>
                        </Card>
